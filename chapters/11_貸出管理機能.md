...
### 🛠️ Header.tsx に貸出履歴リンクを追加する

`frontend/src/components/Header.tsx` を以下のように書き換えます。ログイン中のみ「貸出履歴」リンクを表示します。
...
- 延滞チェックをフロントエンドで実装した
- ヘッダーに貸出履歴リンクを追加し、ナビゲーションを整備した
- 図書館貸出システムとしての主要機能がすべて揃った

> **参考コード**：この章完了時点のコードは [v2.6 - 貸出管理機能](https://github.com/ot-nemoto/fullstack-web-development-workshop-app/releases/tag/v2.6) で確認できます。手順通りに進めてコードが動かない場合、ここと見比べてみてください。
