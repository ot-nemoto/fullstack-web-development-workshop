...
> **参考コード**：この章完了時点のコードは [v1.0 - はじめての全通](https://github.com/ot-nemoto/fullstack-web-development-workshop-app/releases/tag/v1.0) で確認できます。手順通りに進めてコードが動かない場合、ここと見比べてみてください。

### 🛠️ 変更をコミットしてpushする

```bash
git add .
git commit -m "Chapter 3: はじめての全通"
git push
```
